...
wget --no-check-certificate -qO "/tmp/aria2_"$vBit"_thr"$THR".deb" "https://raw.githubusercontent.com/minexavier/MyShells/master/packages/aria2/aria2_1.18.8-1_amd64.deb"
