...
libsodium_url="https://raw.githubusercontent.com/v-c/MyShells/master/packages/ss-libev/libsodium-1.0.13.tar.gz"

mbedtls_file="mbedtls-2.6.0"
mbedtls_url="https://github.com/v-c/MyShells/raw/master/packages/ss-libev/mbedtls-2.6.0-gpl.tgz"
...
get_latest_version(){
    ...
    download_link="https://raw.githubusercontent.com/v-c/MyShells/master/packages/ss-libev/shadowsocks-libev-3.1.0.tar.gz"
    init_script_link="https://raw.githubusercontent.com/v-c/MyShells/master/packages/ss-libev/shadowsocks-libev-debian"
}
...
print_info(){
    clear
    echo "#############################################################"
    echo "# It has been MODIFY by v-c!!!!  please note that!!!    #"
    echo "#$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ #"
...
pre_install(){
    ...
    if ! check_sys packageManager apt; then
        echo -e "[${red}Error${plain}]Please change OS to Debian/Ubuntu and try again."
        exit 1
    fi
    ...
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="lxlxlxlx"
    echo
    echo "---------------------------"
